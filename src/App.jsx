  ...
  return (
    <div className="min-h-screen" style={{ background: brand.paleMint }}>
      <div className="fixed left-4 top-4 z-50 hidden w-64 rounded-3xl bg-white p-4 shadow-xl lg:block">
        <p className="mb-3 text-xs font-semibold uppercase tracking-wide" style={{ color: "rgba(15,61,58,0.45)" }}>V2 clickable flow</p>
        <div className="space-y-1">
          {screens.map((s) => (
            <button
              ...
              style={{
                background: screen === s ? brand.deepTeal : "transparent",
                color: screen === s ? "white" : "rgba(15,61,58,0.72)",
              }}
            >
              {screenLabels[s]}
            </button>
