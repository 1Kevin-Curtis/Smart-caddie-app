...
function LogoMark({ size = 142 }) {
  return (
    <div className="brandLogo" style={{ width: size, height: size * 0.9 }}>
      <div className="brandLogoOrbit" />
      <div className="brandLogoTee" />
      <div className="brandLogoBall">
        <div className="brandLogoDimples">
...
.phone{width:390px;height:844px;border:10px solid #09090b;border-radius:46px;background:white;overflow:hidden;position:relative;box-shadow:0 28px 70px rgba(15,61,58,.22)}
...
.header h2{font-size:18px;margin:0;color:var(--deep);font-family:Poppins,Inter,sans-serif}
.header p{font-size:12px;color:rgba(15,61,58,.58);margin:2px 0 0}
...
h1{font-family:Poppins,Inter,sans-serif;font-size:42px;line-height:.95;letter-spacing:-.04em;margin:0;color:var(--deep)}
h2{font-family:Poppins,Inter,sans-serif;font-size:30px;line-height:1;letter-spacing:-.03em;margin:0}
h3,p{margin:0}
h3{font-size:17px;color:var(--deep)}
.muted{color:rgba(15,61,58,.58);font-size:13px;line-height:1.45;margin-top:7px}
.eyebrow{font-size:12px;text-transform:uppercase;letter-spacing:.08em;font-weight:800;color:rgba(15,61,58,.55);margin-bottom:8px}
.light{color:rgba(232,245,239,.85)}
.card{padding:18px;border-radius:24px;border:1px solid rgba(126,219,180,.25);background:rgba(255,255,255,.95);box-shadow:0 8px 30px rgba(15,61,58,.07)}
.card.dark{background:linear-gradient(145deg,var(--deep),#082d2b);color:white;border-color:transparent;box-shadow:0 12px 34px rgba(15,61,58,.20)}
.card.soft{background:var(--off);color:rgba(15,61,58,.65)}
.card p,.card li{font-size:14px;line-height:1.5;color:rgba(15,61,58,.72)}
.card.dark p{color:#e4e4e7}
.btn{border:0;cursor:pointer;height:54px;border-radius:18px;background:linear-gradient(135deg,var(--mint),#168d77);color:white;font-weight:750;width:100%;padding:0 16px;box-shadow:0 8px 22px rgba(31,167,138,.22)}
...
.nav button{border:0;background:transparent;color:rgba(15,61,58,.72);font-size:11px;display:flex;flex-direction:column;gap:3px;align-items:center}
.nav span{font-size:17px}
.pills{display:flex;flex-wrap:wrap;gap:8px;margin-top:10px}
.pill{border:1px solid rgba(126,219,180,.25);border-radius:999px;background:var(--off);color:rgba(15,61,58,.78);padding:10px 12px;font-size:13px}
...
.journey span{display:block;font-size:11px;margin-top:8px;color:rgba(15,61,58,.72);font-weight:700}
...
.badge,.good{border-radius:999px;background:var(--off);color:rgba(15,61,58,.68);padding:7px 10px;font-size:11px;white-space:nowrap}
...
.holes button{border:1px solid rgba(126,219,180,.18);background:var(--off);color:rgba(15,61,58,.58);border-radius:16px;padding:11px 4px}
...
.trend p{color:rgba(15,61,58,.58)}
.trend span{background:white;border-radius:999px;padding:7px 10px;font-size:11px;color:rgba(15,61,58,.68);height:max-content}
...
/* Approved SugarCaddy welcome screen */
...
.welcomeScreen:after{content:"";position:absolute;left:0;right:0;bottom:96px;height:288px;opacity:.4;background-image:radial-gradient(ellipse at 20% 30%,rgba(31,167,138,.1),transparent 42%),radial-gradient(ellipse at 80% 20%,rgba(126,219,180,.14),transparent 44%);pointer-events:none}
.welcomeHero{position:relative;z-index:1;text-align:center}
.brandLogo{position:relative;display:flex;align-items:center;justify-content:center}
.brandLogoOrbit{position:absolute;width:135%;height:34%;border:10px solid var(--soft);border-left-color:var(--mint);border-right-color:var(--mint);border-radius:999px;transform:rotate(-6deg);opacity:.95}
.brandLogoTee{position:absolute;z-index:1;width:20%;height:42%;top:42%;background:linear-gradient(180deg,var(--deep),#082d2b);clip-path:polygon(18% 0,82% 0,62% 100%,38% 100%)}
.brandLogoBall{position:relative;z-index:2;display:flex;align-items:center;justify-content:center;width:52%;height:52%;border-radius:999px;border:1px solid #d6d6d3;background:radial-gradient(circle at 35% 30%,#fff 0%,#f5f5f3 42%,#d8dad8 100%);box-shadow:0 5px 18px rgba(15,61,58,.12)}
.brandLogoDimples{display:grid;grid-template-columns:repeat(4,1fr);gap:4px;opacity:.35}
.brandLogoDimples span{display:block;width:6px;height:6px;border-radius:999px;background:#71717a}
.welcomeScreen h1{margin-top:8px;font-size:48px;font-weight:800;color:var(--deep);font-family:Poppins,Inter,sans-serif}
.welcomeCopy{max-width:330px;margin:32px auto 0;text-align:center;font-size:26px;font-weight:500;line-height:1.45;color:var(--deep)}
